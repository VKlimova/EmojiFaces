...
class Emojifier {
    ...
    static Bitmap detectFacesandOverlayEmoji(Context context, Bitmap picture) {
        ...
        Log.i(LOG, "detectFaces: number of faces = " + faces.size());
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Log.i(LOG, "whichEmoji: smilingProb = " + face.getIsSmilingProbability());
        Log.i(LOG, "whichEmoji: leftEyeOpenProb = "
                + face.getIsLeftEyeOpenProbability());
        Log.i(LOG, "whichEmoji: rightEyeOpenProb = "
        ...
        Log.i(LOG, "whichEmoji: " + emoji.name());
